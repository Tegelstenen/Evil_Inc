									...
									<div className="flex gap-4">
										<div className="flex-1">
											...
											<input
												id="firstName"
												type="text"
												className="w-full rounded-none border-0 border-b border-gray-300 bg-transparent p-2 text-white shadow-none placeholder:text-gray-400 focus:border-blue-500 focus:outline-none"
												placeholder="Jane"
